...
class TestFourOhFour(TestCase):
    ...
    def test_returns_404(self):
        ...
        self.assertEqual(
            response.status_code, status.NOT_FOUND, "The root endpoint returns 400"
        )
...
class TestHealthCheck(TestCase):
    ...
    def test_returns_200(self):
        ...
        self.assertEqual(
            response.status_code, status.OK, "The health check endpoint returns 200"
        )
    ...
    def test_echos_error(self):
        ...
        with self.app.app_context():
            for code in default_exceptions.keys():
                response = self.client.get(
                    "/", headers={"X-Code": code, "X-Request-ID": "1"}
                )
                self.assertEqual(
