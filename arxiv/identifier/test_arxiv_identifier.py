...
def test_id_without_extra():
    ...
    assert (
        ...
        and arxiv_id.year == 2003
        and arxiv_id.month == 3
        and arxiv_id.num == 98
    )
    assert arxiv_id.is_old_id and not arxiv_id.extra and not arxiv_id.arxiv_prefix
...
def test_id_trailing_slash():
    ...
    assert arxiv_id.is_old_id and arxiv_id.extra == "/" and not arxiv_id.arxiv_prefix
...
def test_id_with_extra():
    ...
    assert arxiv_id.is_old_id and arxiv_id.arxiv_prefix == False
