...
class TestAuthorAffiliationParsing(TestCase):
    def test_split_authors(self):
        self.assertListEqual(split_authors("Simeon Warner"), ["Simeon Warner"])

        self.assertListEqual(
            split_authors("The DELPHI Collaboration, J. Abdallah, et al"),
            ["The DELPHI Collaboration", ",", "J. Abdallah", ",", "et al"],
        )

        self.assertListEqual(
            split_authors("BELLE Collaboration: A Person, Nother Person"),
            ["BELLE Collaboration", ":", "A Person", ",", "Nother Person"],
        )

        self.assertListEqual(
            split_authors("Simeon Warner, Herbert Van de Sompel"),
            ["Simeon Warner", ",", "Herbert Van de Sompel"],
        )

        self.assertListEqual(split_authors("An Author"), ["An Author"], "single author")

        self.assertListEqual(split_authors(""), [], "empty author")
    ...
    def test_parse_author_affil_basic(self):
        self.assertListEqual(
            parse_author_affil("Simeon Warner"), [["Warner", "Simeon", ""]]
        )

        self.assertListEqual(
            parse_author_affil("Simeon Warner Jr"), [["Warner", "Simeon", "Jr"]]
        )
        ...
        self.assertListEqual(
            parse_author_affil("Simeon Warner Sr"), [["Warner", "Simeon", "Sr"]]
        )
        ...
        self.assertListEqual(parse_author_affil("SM Warner"), [["Warner", "SM", ""]])

        self.assertListEqual(parse_author_affil("SM. Warner"), [["Warner", "SM.", ""]])

    def test_parse_author_affil_basic2(self):
        self.assertListEqual(
            parse_author_affil("S.M. Warner"), [["Warner", "S. M.", ""]]
        )

        self.assertListEqual(
            parse_author_affil("John Von Neumann"), [["Von Neumann", "John", ""]]
        )
        ...
        self.assertListEqual(parse_author_affil("del Norte"), [["Norte", "del", ""]])

        self.assertListEqual(
            parse_author_affil("Fred del Norte"), [["del Norte", "Fred", ""]]
        )

        self.assertListEqual(parse_author_affil("BELLE"), [["BELLE", "", ""]])
        ...
        self.assertListEqual(
            parse_author_affil("The DELPHI Collaboration, J. Abdallah, et al"),
            [["The DELPHI Collaboration", "", ""], ["Abdallah", "J.", ""]],
        )

        self.assertListEqual(
            parse_author_affil("Ali Vaziri Astaneh, Federico Fuentes"),
            [["Vaziri Astaneh", "Ali", ""], ["Fuentes", "Federico", ""]],
        )

    def test_parse_author_affil_with_affiliations(self):
        self.assertListEqual(
            parse_author_affil("sum won (lab a)"), [["won", "sum", "", "lab a"]]
        )
        ...
        self.assertListEqual(
            ...
            [
                [
                    ...
                    "E. Trigueros",
                    "",
                    "Departamento de F'isica Aplicada - Universidad de Alicante",
                    "Centro de Astrobiolog'ia - CSIC-INTA",
                ],
                [
                    "Barb'a",
                    "R. H.",
                    "",
                    "Departamento de Astronom'ia - Universidad de La Serena",
                ],
                [
                    "Negueruela",
                    "I.",
        ...
        # [parse_author_affil]
        self.assertListEqual(parse_author_affil(""), [], "parse_author_affil (empty)")
        self.assertListEqual(
