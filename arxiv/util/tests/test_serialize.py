...
class TestISO8601JSONEncoder(TestCase):
    ...
    def test_encode_with_date(self):
        ...
        self.assertEqual(
            serialize.dumps(date(year=1993, month=11, day=3)), '"1993-11-03"'
        )
        self.assertEqual(
    ...
    def test_encode_with_datetime_tz(self):
        ...
        self.assertEqual(
            serialize.dumps({"date": datetime(year=1993, month=11, day=3, tzinfo=ET)}),
...
class TestISO8601JSONDecoder(TestCase):
    ...
    def test_decode_with_date(self):
        ...
        self.assertEqual([{"date": ["1993"]}], serialize.loads('[{"date": ["1993"]}]'))
