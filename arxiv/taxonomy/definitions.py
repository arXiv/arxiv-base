...
GROUPS: Dict[str, Group] = {
    ...
    "grp_test": Group(
        id="grp_test", full_name="Test", is_active=True, start_year=1995, is_test=True
    ),
    "grp_q-fin": Group(
        id="grp_q-fin",
...
ARCHIVES_ACTIVE = {key: arch for key, arch in ARCHIVES.items() if arch.is_active}
...
CATEGORIES_ACTIVE = {key: cat for key, cat in CATEGORIES.items() if cat.is_active}
