...
class Complaint(IntEnum):
    ...
    CONTAINS_URL = 39
    CONTAINS_DOI = 40 # CAREFUL: contains something which appears to be a DOI
    CONTAINS_ACCEPTED = 41
    CONTAINS_SUBMITTED = 42
    MUST_CONTAIN_YEAR = 43
    CONTAINS_BIBTEX = 44
    CONTAINS_DOI2 = 45 # CAREFUL: contains the *string* "DOI".
    CONTAINS_ARXIV_DOI = 46 # Contains the string "arxiv-doi" - useful?
    BAD_DOI_PREFIX = 47
