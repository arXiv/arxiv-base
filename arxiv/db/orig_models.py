...
class CheckRoles(Base):
    ...
    check_role_id = Column(INTEGER(11), primary_key=True)
    name = Column(VARCHAR(40), nullable=False)
    description = Column(VARCHAR(200), nullable=True, server_default=text("''"))
...
class CheckResultViews(Base):
    ...
    check_result_view_id = Column(INTEGER(11), primary_key=True)
    name = Column(VARCHAR(40), nullable=False)
    description = Column(VARCHAR(200), nullable=True, server_default=text("''"))
...
class CheckTargets(Base):
    ...
    check_target_id = Column(INTEGER(11), primary_key=True)
    name = Column(VARCHAR(40), nullable=False)
    description = Column(VARCHAR(200), nullable=True, server_default=text("''"))
...
class Checks(Base):
    ...
    check_id = Column(INTEGER(11), primary_key=True)
    check_target_id = Column(ForeignKey('arXiv_check_targets.check_target_id'), index=False)
    #, ondelete='CASCADE', onupdate='CASCADE'
    check_role_id = Column(ForeignKey('arXiv_check_roles.check_role_id'), index=False)
    check_result_view_id = Column(ForeignKey('arXiv_check_result_views.check_result_view_id'), nullable=False, server_default=text("'1'"), index=False)
    name = Column(VARCHAR(40), nullable=False)
    description = Column(VARCHAR(200), nullable=True)
    enable_check = Column(INTEGER(1), nullable=False, server_default=text("'0'"))
    enable_hold = Column(INTEGER(1), nullable=False, server_default=text("'0'"))
    enable_queue = Column(INTEGER(1), nullable=False, server_default=text("'0'"))
    retry_minutes = Column(INTEGER(11), nullable=False, server_default=text("'0'"))
    optional = Column(INTEGER(1), nullable=False, server_default=text("'1'"))
    persist_response = Column(INTEGER(1), nullable=False, server_default=text("'0'"))
...
class CheckResults(Base):
    ...
    check_result_id = Column(INTEGER(11), primary_key=True)
    submission_id = Column(ForeignKey('arXiv_submissions.submission_id'), nullable=False, index=True)
    data_version = Column(INTEGER(11), nullable=False, server_default=text("'0'"))
    metadata_version = Column(INTEGER(11), nullable=False, server_default=text("'0'"))
    ...
    ok = Column(INTEGER(1), nullable=False)
...
class CheckResponses(Base):
    ...
    check_response_id = Column(INTEGER(11), primary_key=True)
