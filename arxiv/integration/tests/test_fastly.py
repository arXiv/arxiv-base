...
from arxiv.integration.fastly.purge import (
    purge_fastly_keys,
    _purge_category_change,
    purge_cache_for_paper,
    _get_category_and_date,
)
...
class TestPurgeFastlyKeys(unittest.TestCase):
    ...
    def test_purge_single_key(self, MockApiClient, MockPurgeApi: PurgeApi):
        ...
        mock_api_instance.purge_tag.assert_called_once_with(
            service_id="hCz5jlkWV241zvUN0aWxg2", surrogate_key="test"
        )
    ...
    def test_purge_multiple_keys(self, MockApiClient, MockPurgeApi: PurgeApi):
        ...
        mock_api_instance.bulk_purge_tag.assert_called_once_with(
            service_id="umpGzwE2hXfa2aRXsOQXZ4", purge_response={"surrogate_keys": keys}
        )
...
def test_purge_category_change_alias_cats(mockToday, mockDBQuery):
    ...
    result = _purge_category_change(Identifier("1001.5678"))
    expected = [
        "list-2010-01-nlin.SI",
        "list-2010-nlin.SI",
        "list-2010-01-nlin",
        "list-2010-nlin",
        "list-2010-01-eess.SY",
        "list-2010-eess.SY",
        "list-2010-01-eess",
        "list-2010-eess",
        "list-2010-01-cs",
        "list-2010-cs",
        "list-2010-01-grp_physics",
        "list-2010-grp_physics",
    ]
    assert sorted(result) == sorted(expected)
