...
# -*- coding: utf-8 -*-
#
# arXiv base documentation build configuration file, created by
...
htmlhelp_basename = 'arXivbasedoc'
...
latex_documents = [
    (master_doc, 'arXivbase.tex', 'arXiv base Documentation',
     'Jane Bloggs', 'manual'),
]
...
man_pages = [
    (master_doc, 'arxivbase', 'arXiv base Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'arXiv-base', 'arXiv Base Documentation',
     author, 'arXiv-base', 'One line description of project.',
     'Miscellaneous'),
]
