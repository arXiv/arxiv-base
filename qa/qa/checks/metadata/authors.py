...
class AuthorsAreValid(BaseAggregateCheck):
    ...
    _checks = (
        ...
        DoesNotEndWithPunctuation(on_failure_policy=OnFailurePolicy.REJECT, data="metadata", field="authors"),
        ...
        NoExcessiveCapitals(on_failure_policy=OnFailurePolicy.REJECT, data="metadata", field="authors"),
        RequiresSpaceAroundParens(on_failure_policy=OnFailurePolicy.REJECT, data="metadata", field="authors"),
        NotTooManyLines(20, on_failure_policy=OnFailurePolicy.REJECT, data="metadata", field="authors"),
